...
public class ServletHandler extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			JSONArray solrJSONObj = APICallHandler.solrCall(query, 50);
			JSONArray hitsJSONObj = APICallHandler.hitsCall(solrJSONObj);
			JSONArray pagerankJSONObj = APICallHandler.PageRankCall(solrJSONObj);
			...
			jsonObject.put("pagerank", pagerankJSONObj);
