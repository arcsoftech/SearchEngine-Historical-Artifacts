...
public class AssociationCluster {
    ...
    public String getExpandedQuery() {
        ...
        {
            singledoc.content[0]=singledoc.content[0].replaceAll("[^A-Za-z]+", " ");
            tokens = singledoc.content[0].split(" ");
            count++;
